...
const defaultContent: Record<ElementType, any> = {
  ...
  profile: {
    name: "Jane Doe",
    role: "Designer",
    bio: "I love making things look good.",
  ...
  product_card: {
    ...
    price: "$99.99",
    image: "https://picsum.photos/seed/prod/300/200",
    buttonText: "Add to Cart",
  },
  blog_card: {
    title: "10 Tips for Better Web Design",
    excerpt: "Learn how to make your website stand out...",
    author: "Jane Doe",
    date: "Oct 12, 2026",
  ...
  timeline: [
    { date: "2023", title: "Founded", desc: "Company was born" },
    { date: "2026", title: "Global", desc: "Expanded globally" },
  ],
  carousel: [
  ...
  stock_ticker: { symbol: "AAPL", price: "150.00", change: "+1.5%" },
  price_card: {
    plan: "Pro",
    price: "$29/mo",
  ...
  map_pin: { lat: 40.7128, lng: -74.006, label: "New York City" },
  animated_counter: { endValue: 1000, suffix: "+" },
  tooltip_text: { text: "Hover me", tooltip: "This is a helpful tip!" },
  dropdown_menu: {
    label: "Select Option",
...
const defaultStyle: Record<ElementType, ElementStyle> = {
  ...
  stats_grid: { display: "flex", gap: "16px", width: "100%" },
  timeline: {
    width: "300px",
  ...
  color_picker: { display: "flex", alignItems: "center", gap: "8px" },
  ...
  animated_counter: { fontSize: "36px", fontWeight: "bold", color: "#3b82f6" },
  tooltip_text: { cursor: "pointer", borderBottom: "1px dotted #6b7280" },
  dropdown_menu: {
    padding: "8px",
    border: "1px solid #ccc",
    borderRadius: "4px",
      ...
      elements: [
        ...state.elements,
        {
          ...
          events: [
            ...
            ? [{ id: uuidv4(), trigger: "onClick", actions: [] }]
            : type === "loading_screen"
              ? [
                  {
                    id: uuidv4(),
